...
class Graph extends Component {
      ...
      this.basicData = [
         {
            ...
            datasets: [
               {
                  label: '',
                  data: this.state.oneDyPriceData == null ? 'not enough' : this.state.oneDyPriceData,
                  borderColor: '#3f51b5',
                  tension: 0,
                  fill: true,
                  pointRadius: 0,
   ...
   render() {
      let chartOptions;
      if (this.state.oneDyPriceData == null) {
         chartOptions = [
            ...
            <div className="bg-white py-4 px-1 border-round col-10 col-offset-1">
               <div className="flex justify-content-between">
                  <div className="ml-2 mb-2">
                     <div className="flex">
                        <img
                           src={assets.logo_url} alt=""
                           className="border-circle h-2rem w-2.5 mr-2"
                           onError={this.fallbackAvatar}
                        />
                        <div className="text-3xl">{assets.contract_name}</div>
                     </div>
                     <div className="text-4xl font-semibold">{assets.contract_ticker_symbol}</div>
